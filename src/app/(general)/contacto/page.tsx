  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <form action="#" className="space-y-8">
          ...
          <div className="sm:col-span-2">
              <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Mensaje</label>
          ...
          <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg  sm:w-fit hover:bg-slate-800  focus:outline-nonez   dark:bg-gray-700">Enviar</button>
      </form>
  </div>
</section>
    </main>
